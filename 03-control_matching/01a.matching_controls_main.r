...
# 
saveRDS(matched_dataset1_full,paste0(data_path, "matched_cohorts/matched_preg_outcomes_cohort.rds") )
...
source("control_matching/matching_process.r")
# 
saveRDS(matched_dataset1_full,paste0(data_path, "matched_cohorts/matched_congenital_cohort.rds") )
# 

# New 18/03/2025 - add in new any_CC flag 
cc_matched <- readRDS(paste0(data_path, "matched_cohorts/matched_congenital_cohort.rds"))
...
saveRDS(cc_matched_new,paste0(data_path, "matched_cohorts/matched_congenital_cohort.rds") )
...
source("control_matching/matching_process.r")
# 
saveRDS(matched_dataset1_full,paste0(data_path, "matched_cohorts/matched_developmental_cohort.rds") )
# 
