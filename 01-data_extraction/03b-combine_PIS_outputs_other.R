##03b-combine_PIS_outputs_other.R ####
# Description of content;
# Script to prepare PIS data for medicines exposure dataset
# Data sets to be linked are Home Care, HEPMA, and PIS
# Script prepares PIS records where mental health, pain, and folic acid medicines are prescribed/administered
...
#### 2. Read in and check PIS data - MH, pain & folic acid ####
# Rerunning other meds with full 2010 
pis_data_1 <- read_xlsx(paste0(folder_data_path, 'scomed_extracts/other_meds/other_2010_full.xlsx'), col_names = TRUE)
pis_data_2 <- read_xlsx(paste0(folder_data_path, 'scomed_extracts/other_meds/other_2011_full.xlsx'), col_names = TRUE)
pis_data_3 <- read_xlsx(paste0(folder_data_path, 'scomed_extracts/other_meds/other_2012_full.xlsx'), col_names = TRUE)
pis_data_4 <- read_xlsx(paste0(folder_data_path, 'scomed_extracts/other_meds/other_2013_full.xlsx'), col_names = TRUE)
pis_data_5 <- read_xlsx(paste0(folder_data_path, 'scomed_extracts/other_meds/other_2014_full.xlsx'), col_names = TRUE)
pis_data_6 <- read_xlsx(paste0(folder_data_path, 'scomed_extracts/other_meds/other_2015_full.xlsx'), col_names = TRUE)
pis_data_7 <- read_xlsx(paste0(folder_data_path, 'scomed_extracts/other_meds/other_2016_full.xlsx'), col_names = TRUE)
pis_data_8 <- read_xlsx(paste0(folder_data_path, 'scomed_extracts/other_meds/other_2017_full.xlsx'), col_names = TRUE)
pis_data_9 <- read_xlsx(paste0(folder_data_path, 'scomed_extracts/other_meds/other_2018_full.xlsx'), col_names = TRUE)
pis_data_10 <- read_xlsx(paste0(folder_data_path, 'scomed_extracts/other_meds/other_2019_full.xlsx'), col_names = TRUE)
pis_data_11 <- read_xlsx(paste0(folder_data_path, 'scomed_extracts/other_meds/other_2020_full.xlsx'), col_names = TRUE)
pis_data_12 <- read_xlsx(paste0(folder_data_path, 'scomed_extracts/other_meds/other_2021_full.xlsx'), col_names = TRUE)
pis_data_13 <- read_xlsx(paste0(folder_data_path, 'scomed_extracts/other_meds/other_2022_full.xlsx'), col_names = TRUE)
pis_data_14 <- read_xlsx(paste0(folder_data_path, 'scomed_extracts/other_meds/other_2023_full.xlsx'), col_names = TRUE)
pis_data_15 <- read_xlsx(paste0(folder_data_path, 'scomed_extracts/other_meds/other_2024_01_03.xlsx'), col_names = TRUE)
...
arrow::write_parquet(pis_data,
                     sink = paste0(folder_data_path, "scomed_extracts/other_meds/other_data_05_09.parquet"),
                     compression = "zstd")
